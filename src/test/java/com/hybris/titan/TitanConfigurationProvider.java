...
public class TitanConfigurationProvider
{
	...
	/**
	 * Creates {@link GraphDatabaseConfiguration} based on {@code titan.properties} resource.
	 *
	 * @return GraphDatabaseConfiguration
	 * @throws ConfigurationException when resource could not to be loaded
